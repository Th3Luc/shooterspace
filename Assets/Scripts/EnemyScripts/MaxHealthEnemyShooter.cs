...
public class MaxHealthEnemyShooter : MonoBehaviour, IDamageable
{
    ...
    public void TakeDamage(int damage)
    {
        ...
        if (currentHealth <= 0)
        {
            ...
            player.GetComponent<PlayerHealth>().GainHealth(25);
            player.GetComponent<PlayerHealth>().IncreaseMaxHealth(25);
            OnDeath();
            Destroy(gameObject);
        }
    }
